...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      wellPanel(
        textInput("txtModelName","Statement2",placeholder = "Statement3"),
        textInput("txtDecison","Statement4", placeholder = "Statement5"),
        textInput("txtCriteria","Statement6", placeholder = "Statement7"),
        uiOutput("uiDynaFactors")
      ),
      wellPanel(
        textInput("txtAlternatives", "Statement8", placeholder = "Statement9"),
        actionButton("btnUpdateAlternatives", "Statement10")
      )
    ),
    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Statement11",
                 p("Statement12"),
                 textInput("txtUserEmail", "Statement13", placeholder = "Statement14"),
                 textInput("txtUserPin", "Statement15", placeholder = "Statement16"),
                 actionButton("btnLoadModels", "Statement17"),
                 h4("Statement18"),
        ...
        tabPanel("Statement19",
                 wellPanel(
                   h4("Statement20"),
                   actionButton("btnSaveModel", "Statement21"),
                   actionButton("btnRebuildTree", "Statement22"),
                   actionButton("btnLoadExample", "Statement23")
                 ),
                 grVizOutput("xx"),
                 wellPanel(
                   h3("Statement24"),
